...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002303784930"))
...
POST_SHORT_API = environ.get('POST_SHORT_API', 'gplinks.com')
POST_SHORT_URL = environ.get('POST_SHORT_URL', '89c5f49bb30bf45ddae5d35314cc7525a36aceb0')
